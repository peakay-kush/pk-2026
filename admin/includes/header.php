...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="tutorials.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'tutorials.php' ? 'active' : ''; ?>">
    ...
    <div class="main-content">
        <div class="top-navbar">
            ...
            <div>
                <span class="text-muted me-3"><i class="far fa-clock"></i> <?php echo date('F d, Y - h:i A'); ?></span>
                <span class="badge bg-primary"><?php echo htmlspecialchars($_SESSION['admin_name'] ?? 'Admin'); ?></span>
            </div>
        </div>
